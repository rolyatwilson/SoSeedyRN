...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"SoSeedyRN"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit SoSeedyRN" action:@selector(terminate:) keyEquivalent:@"q"];
